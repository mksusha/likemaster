...
export default function HandymanBlock() {
    const listItem = {
            ...
            <div className="mx-auto grid lg:grid-cols-2 gap-8 md:gap-16 items-stretch">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl text-left font-extrabold mb-6 leading-tight text-darkAccent-default">
                        Мастер на час <br className="hidden sm:block" /> — всё под контролем
                    </h2>
                    <p className="text-base sm:text-xl text-left text-gray-700 mb-8 max-w-xl">
                        Мелкий бытовой ремонт: сборка мебели, замена замков, крепление полок.
                    </p>
                    ...
                    >
                        {[
                            'Сборка шкафов, кроватей и столов',
                            'Замена дверных замков и ручек',
                            'Крепление полок, карнизов, телевизоров',
                            'Навеска картин и зеркал',
                            'Устранение скрипов и люфтов',
                            'Мелкий ремонт по дому и в офисе',
                        ].map((item, i) => (
                            <motion.li
                                key={i}
                                variants={listItem}
                    ...
                    <div className="flex items-center bg-darkAccent px-3 py-4 rounded-3xl text-white font-semibold text-base sm:text-lg max-w-xl mt-auto">
                        <Hammer className="w-10 h-10 sm:w-7 sm:h-7 mr-3 text-white flex-shrink-0" />
                        <span>Надёжный помощник в любое время</span>
                    </div>
                </motion.div>
